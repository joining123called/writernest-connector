          ...
          <div className="bg-white/10 backdrop-blur-2xl border border-white/20 rounded-3xl shadow-2xl p-8 relative overflow-hidden dark:bg-black/20">
            ...
            <div className="relative">
              <div className="text-center mb-8">
                <h1 className="text-3xl font-bold tracking-tight text-foreground/90">Reset Admin Password</h1>
              ...
              {isSubmitted ? (
                ...
                <>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      <Label htmlFor="email" className="text-sm font-medium text-foreground/90">Admin Email</Label>
