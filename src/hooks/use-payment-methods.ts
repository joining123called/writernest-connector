  ...
  const paymentMethods: PaymentMethod[] = [
    {
      ...
      isEnabled: settings?.enableStripe as boolean || false,
    ...
    },
    {
      id: 'paypal',
      name: 'PayPal',
      isEnabled: settings?.enablePayPal as boolean || false,
    ...
    },
    {
      id: 'skrill',
      name: 'Skrill',
      isEnabled: settings?.enableSkrill as boolean || false,
    ...
    },
    {
      id: 'mpesa',
      name: 'M-Pesa',
      isEnabled: settings?.enableMpesa as boolean || false,
    ...
    },
    {
      id: 'flutterwave',
      name: 'Flutterwave',
      isEnabled: settings?.enableFlutterwave as boolean || false,
    ...
    },
    {
      id: '2checkout',
      name: '2Checkout',
      isEnabled: settings?.enable2Checkout as boolean || false,
    ...
    },
    {
      id: 'paystack',
      name: 'Paystack',
      isEnabled: settings?.enablePaystack as boolean || false,
    ...
    },
    {
      id: 'authorizenet',
      name: 'Authorize.net',
      isEnabled: settings?.enableAuthorizeNet as boolean || false,
