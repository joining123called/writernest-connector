...
import { PaymentMethodsSchema } from '@/components/settings/payment-methods/schema';
  ...
  const paymentMethods: PaymentMethod[] = [
    {
      ...
      isEnabled: settings?.enableStripe || false,
    ...
    },
    {
      id: 'paypal',
      name: 'PayPal',
      isEnabled: settings?.enablePayPal || false,
    ...
    },
    {
      id: 'skrill',
      name: 'Skrill',
      isEnabled: settings?.enableSkrill || false,
    ...
    },
    {
      id: 'mpesa',
      name: 'M-Pesa',
      isEnabled: settings?.enableMpesa || false,
    ...
    },
    {
      id: 'flutterwave',
      name: 'Flutterwave',
      isEnabled: settings?.enableFlutterwave || false,
    ...
    },
    {
      id: '2checkout',
      name: '2Checkout',
      isEnabled: settings?.enable2Checkout || false,
    ...
    },
    {
      id: 'paystack',
      name: 'Paystack',
      isEnabled: settings?.enablePaystack || false,
    ...
    },
    {
      id: 'authorizenet',
      name: 'Authorize.net',
      isEnabled: settings?.enableAuthorizeNet || false,
